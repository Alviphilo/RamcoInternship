        ...
        data.forEach(row => {
          tbody.innerHTML += `
            <tr>
              ...
              <td contenteditable data-field="backup_status">${row.rdp_user}</td>
              <td contenteditable data-field="backup_status">${row.rdp_password}</td>
              <td contenteditable data-field="backup_status">${row.backend_server}</td>
              <td contenteditable data-field="backup_status">${row.backend_user}</td>
              <td contenteditable data-field="backup_status">${row.backend_password}</td>
              <td contenteditable data-field="backup_status">${row.vpn}</td>
              <td contenteditable data-field="backup_status">${row.connection_method}</td>
